...
api-design-principles,architecture,composition-patterns,debugging-strategies,docx,figma,figma-implement-design,frontend-design,geo-fundamentals,gh-address-comments,gh-fix-ci,lint-and-validate,mcp-builder,mobile-first-design-rules,next-best-practices,next-cache-components,next-upgrade,pdf,playwright,pptx
