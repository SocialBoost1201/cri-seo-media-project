      ...
      <div className="relative flex overflow-hidden group">
        ...
        >
          {MARQUEE_ITEMS.map((logo, index) => (
            <div
              key={`row1-${index}`}
              className={`flex items-center justify-center opacity-60 hover:opacity-100 transition-opacity duration-300 grayscale hover:grayscale-0 cursor-default select-none text-xl sm:text-2xl ${logo.color} ${logo.font}`}
            >
